...
public class QuestionBusiness {
    ...
    @Transactional(propagation = Propagation.REQUIRED)
    public List<QuestionEntity> getAllQuestionsByUserId(final String authToken, final String userId) throws AuthorizationFailedException, UserNotFoundException {
        UserAuthEntity userAuthEntity = userDao.getUserAuthByAccessToken(authToken);
        ...
        if(userAuthEntity == null) {
            ...
            if(userEntity == null) {
                ...
                return questionDao.allQuestionsByUser(userEntity);
            }
        }
    }
}
